...
function showAd() {
    ...
    adWindow.innerHTML = '<img src="rek.jpg" alt="Реклама"> <div id="timer" style="position: absolute; top: 10px; left: 50%; transform: translateX(-50%); width: 40px; height: 40px; background-color: #ffc0cb; border-radius: 50%; display: flex; justify-content: center; align-items: center; font-size: 20px;"></div> <div id="closeButton" style="position: absolute; top: 10px; right: 10px; cursor: pointer; opacity: 0.5; font-size: 30px;">&times;</div>';
